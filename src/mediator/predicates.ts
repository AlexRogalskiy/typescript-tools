...
export const optional = <T extends PredicateSchema>(predicateSchema: T): BasePredicate<ValidatedObject<T>> =>
...
export function isValid<T>(value: any, predicate: BasePredicate<T>): value is T {
