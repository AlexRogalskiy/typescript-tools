import { IssueType, Locale } from '../../typings/domain-types'
...
export const Message = {
    findByKey: (key: string, locale: Keys<Locale>): string => messages[key][locale],
    PROGRESS_INIT_BEGIN: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    PROGRESS_RUN_BEGIN: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    SPACE_URL_REQUIRED: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    API_KEY_REQUIRED: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    PROJECT_KEY_REQUIRED: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    SPACE_OR_PROJECT_NOT_FOUND: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    AUTHENTICATE_FAILED: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    API_ACCESS_ERROR: (error: Error, locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_ERROR_LINE: (lineNumber: number, locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_SUMMARY_EMPTY: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_ISSUE_TYPE_EMPTY: (locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_PARENT_ISSUE_KEY_NOT_FOUND: (parentIssueKey: Optional<string>, locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_CUSTOM_FIELD_VALUE_IS_REQUIRED: (definitionName: string, locale: Keys<Locale>): string => {
        const msg = {
    ...
    VALIDATE_CUSTOM_FIELD_VALUE_IS_REQUIRED_ISSUE_TYPE: (
    ...
    VALIDATE_CUSTOM_FIELD_VALUE_IS_REQUIRED_UNSUPPORTED: (
        definitionName: string,
        locale: Keys<Locale>,
    ): string => {
        const msg = {
    ...
    VALIDATE_CUSTOM_FIELD_VALUE_IS_NUMBER: (
        definitionName: string,
        input: string,
        locale: Keys<Locale>,
    ): string => {
    ...
    VALIDATE_CUSTOM_FIELD_VALUE_IS_DATE: (
        definitionName: string,
        input: string,
        locale: Keys<Locale>,
    ): string => {
    ...
    ALREADY_BEEN_CHILD_ISSUE: (issueKey: string, locale: Keys<Locale>): string => {
        const msg = {
    ...
    INVALID_ROW_LENGTH: (locale: Keys<Locale>): string => {
        const msg = {
