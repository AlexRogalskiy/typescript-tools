...
declare namespace OC {
    ...
    namespace Util {
        ...
        namespace History {
            function pushState(params: string|unknown, url?: string): void

            function replaceState(params: string|unknown, url?: string): void
        }
    }

    namespace dialogs {
        const YES_NO_BUTTONS: number;
        ...
        function confirmDestructive(text: string, title: string, buttons: {type: number, confirm: string, cancel: string, confirmClasses?: string}, callback: (result: boolean) => void, modal?: boolean): void;
    }
