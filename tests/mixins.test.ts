...
export namespace Mixins_Test {
    ...
    export namespace Mixins_Test1 {
        ...
        beforeAll(() => {
            console.log("Mixins test suite-1 started")
            console.time("Execution time took")
        })

        afterAll(() => {
            console.log("Mixins test suite-1 finished")
    ...
    export namespace Mixins_Test2 {
        ...
        beforeAll(() => {
            console.log("Mixins test suite-2 started")
            console.time("Execution time took")
        })

        afterAll(() => {
            console.log("Mixins test suite-2 finished")
            console.timeEnd("Execution time took")
        })
    ...
    export namespace Mixin_Tests3 {
        ...
        beforeAll(() => {
            console.log("Mixins test suite-3 started")
            console.time("Execution time took")
        })

        afterAll(() => {
            console.log("Mixins test suite-3 finished")
            console.timeEnd("Execution time took")
        })
    ...
    export namespace Mixin_Tests4 {
        ...
        beforeAll(() => {
            console.log("Mixins test suite-4 started")
            console.time("Execution time took")
        })

        afterAll(() => {
            console.log("Mixins test suite-4 finished")
            console.timeEnd("Execution time took")
        })
