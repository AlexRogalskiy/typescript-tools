...
export class DateFormat {
    ...
    private static timezone = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g
    ...
    parse(date, mask, utc) {
        ...
        const flags = {
            ...
            T: H < 12 ? "A" : "P",
            TT: H < 12 ? "AM" : "PM",
            Z: utc ? "UTC" : (String(date).match(DateFormat.timezone) || ['']).pop()?.replace(DateFormat.timezoneClip, ''),
